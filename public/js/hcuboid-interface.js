...
/*function dist(piece,pos){ //l_inf distance between piece and pos
  let a=Math.abs
  return Math.max(a(piece.x-pos.x), a(piece.y-pos.y), a(piece.board.l-pos.l), a(piece.board.t-pos.t))
}*/
